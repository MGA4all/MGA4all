...
def create_target_variables(test_config, n_mga):
    ...
    deployed_capacity_series = extract_deployed_capacity(target_techs, n_mga, spatial)
...
def hop_skip_jump_algorithm(test_config, n_costopt, noise_threshold=0.001):
    ...
    mga_spatial_alternatives[0] = extract_deployed_capacity(target_techs, n_costopt, spatial=True)
    mga_alternatives[0] = extract_deployed_capacity(target_techs, n_costopt, spatial=False)
